...
initWeaponCvars()
{
	...
	level.allowjeepgunner = getCvar("scr_allow_jeep_gunner");
	if(level.allowjeepgunner == "")
		level.allowjeepgunner = "1";
	setCvar("scr_allow_jeep_gunner", level.allowjeepgunner);
}
