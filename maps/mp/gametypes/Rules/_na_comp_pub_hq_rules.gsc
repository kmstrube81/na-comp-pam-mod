Rules()
{
	...
	// HQ Settings
	setcvar("scr_hq_scorelimit", "1000000000");
	setcvar("scr_hq_timelimit", "20");
	...
	// Score Settings
	setcvar("scr_hq_clearscoreeachhalf", "0");	// Re-set Players Score at halftime? 1=Yes 0=No  Used to reset battlerank if it is on.
